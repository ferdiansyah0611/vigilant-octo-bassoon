 ...
 */
final class Version20220125092154 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE "order" (id INT NOT NULL, product_id INT NOT NULL, status VARCHAR(255) NOT NULL, count INT NOT NULL, PRIMARY KEY(id))');
